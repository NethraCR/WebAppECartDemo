    ...
    public class ShoppingController : Controller
    {
        ...
        public ActionResult Index()
        {
            IEnumerable<ShoppingViewModel> listOfShoppingViewModels = (from objItem in objECartDbEntities.Items
                                                                       join 
                                                                       objCate in objECartDbEntities.Categoriesses
       ...
       /* public ActionResult Delete(string itemId)
        {
            ...
            if(listOfShoppingCartModels.Any())
            {
                var orderObj = listOfShoppingCartModels.FirstOrDefault(x => x.ItemId == itemId);
                listOfShoppingCartModels.Remove(orderObj);
                Session["CartItem"] = listOfShoppingCartModels;
            }
